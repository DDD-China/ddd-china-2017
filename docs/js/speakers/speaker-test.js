var speakers = [{
    ...
    '方案介绍：<br>' +
    '1、建模方面，先从战略层面建立供应链、商品、交易、消费、资金等限界上下文，并根据业务场景，将服务划分为业务流程层和领域服务层，' +
    '然后从框架层面使用父子工程构建了基本的分层框架，最后在战术层面使用聚合根、实体、值对象、CQRS等手段分解代码的复杂性，并根据业务特点抽' +
    '象出商品渠道、订单引擎、资金流等模型<br>' +
    '2、实施层面，客户端与后台的交互使用http接口，后台之间的同步调用使用thrift接口，非同步调用使用kafka，服务治理使用美团的octo平台，' +
    '单机上的服务使用jetty+spring+mybatis等开发<br><br>' +
    '实施后效果说明：<br>' +
    '1、扩展性方面，目前支持了卖品、衍生品、电影票、演出等各种类型的交易场景，同时支持验券、物流、投币等消费场景，也支持' +
    '现金、优惠券、促销活动、会员卡等支付结算方式<br>' +
    '2、稳定性方面，在日PV过亿，QPS超5000的情况下，系统运转状况良好。',
    'speaker-outline':
    '<ul>' +
    '<li>构造领域驱动的施展环境</li>' +
    '<li>战略层面的设计和实施</li>' +
    ...
    'speaker-name':
        '刘学斌',
    'speaker-introduction':
        '用友畅捷通信息技术公司云产品研发部专家、架构师',
    'speaker-information':
    '<span class="bold-text">刘学斌</span><br>用友畅捷通软件开发公司专家、架构师，近20年软件开发经验，擅长领域驱动设计建模、' +
    ...
    'speaker-topic':
    '<span class = "bold-text">「微服务架构在企业应用云产品中实践」</span><br>' +
    ...
    'speaker-introduction':
        '泰然集团CTO',
    'speaker-information':
    '<span class="bold-text">付银海</span><br>17年软件研发从业经历，现任泰然集团CTO，曾在美国工作多年，历任元宝铺CTO负责技术团' +
